            ...
            <div class="container grid px-6 mx-auto">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full  text-sm text-right text-gray-500 ">
                        ...
                        <tbody id="showdata">
                        <?php
                        $orders = $con->query("SELECT * FROM orders JOIN brands.product p on p.product_id = orders.product_id WHERE shipping_company_id='$shipping_company' AND order_status!='قيد الانتظار'");
                        foreach ($orders as $order): ?>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE orders SET order_status='$order_status' WHERE product_id='$product_id'";
                                $result = $con->exec($sql);
