            ...
            <div class="container grid px-6 mx-auto">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex flex-col items-end pr-5 pt-3 bg-white">
                        <a href="add_return_order.php" class="bg-viridian-green-500 mt-3 mb-3 px-8 py-3 border border-viridian-green-500 text-white font-medium
                    rounded-md hover:bg-transparent hover:text-viridian-green-500">إنشاء طلب أرجاع جديد</a>
                    ...
                    <table class="w-full  text-sm text-right text-gray-500 ">
                        ...
                        <tbody id="showdata">
                        <?php
                        $return_orders = $con->query("SELECT * FROM return_order JOIN brands.product p on p.product_id = return_order.product_id WHERE customer_id='$customer_id'");
                        foreach ($return_orders as $return_order): ?>
                            <tr class="bg-white border-b hover:bg-gray-50 ">
                                ...
                                <td class="text-center py-4 font-bold">
                                    <?php echo $return_order['return_date'] ?>
                                </td>
                                ...
                                <td class="text-center py-4">
                                    <div class="flex flex-col items-center">
                                        <img src="../assets/uploads/<?php echo $return_order['image'] ?>" alt="product image"
                                             class=" w-20 rounded">
                                    </div>
                                </td>
                                <td class="text-center py-4 font-bold">
