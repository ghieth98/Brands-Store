...
$orders = $con->query("SELECT * FROM order_product JOIN brands.orders o on o.order_id = order_product.order_id JOIN brands.product p on p.product_id = order_product.product_id  WHERE customer_id='$customer_id'");
?>
<!doctype html>
...
//            Add return order to database
                $sql = "INSERT INTO return_order (product_id, customer_id, return_date, return_description) VALUES ('$product', '$customer_id', NOW(), '$description')";
                $result = $con->exec($sql);
