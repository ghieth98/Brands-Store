            ...
            <div class="container grid px-6 mx-auto">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full  text-sm text-right text-gray-500 ">
                        ...
                        <tbody id="showdata">
                        <?php
                        $orders = $con->query("SELECT * FROM order_product join brands.product p on p.product_id = order_product.product_id join brands.orders o on o.order_id = order_product.order_id where o.order_id='$order_id'");
                        ...
                        foreach ($orders as $order):?>
                            <tr class="bg-white border-b hover:bg-gray-50 ">
                                ...
                                <td class="text-center py-4 font-bold">
                                    <?php echo $order['price'] * $order['order_quantity'] + $order['shipping_price']  ?> SAR
                                </td>
                                <td class="text-center py-4 font-bold">
