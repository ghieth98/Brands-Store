            ...
            <div class="container grid px-6 mx-auto">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full text-sm text-right text-gray-500 ">
                        ...
                        <tbody id="showdata">
                        <?php
                        $return_orders = $con->query("SELECT * FROM return_order JOIN brands.product p on p.product_id = return_order.product_id WHERE merchant_id='$merchant_id'");
                        foreach ($return_orders as $return_order):?>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 ">
                                ...
                                <td class="text-center py-4 font-bold">
                                    <?php echo $return_order['price'] ?> SAR
                                </td>

                                <td class="text-center py-4 font-bold">
                                    <?php echo $return_order['description'] ?>
                                </td>
