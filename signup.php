...
كلمة السر غير متطابقة!                                                
        ...
        $mail->setFrom('', 'Credentials Verification');
...
We would like to congrat you
        ...
        if ($mail->send()) {
            ...
            header('Location: otp.php?message=success_msg');
        } else {
            echo '<div id="alert-2" dir="rtl" class="flex items-center p-4 m-4 text-white rounded-lg bg-red-500 " role="alert">
                                        <div class="ml-3 text-xl font-medium">
حدث خطأ!                                                
                ...
                <form class="space-y-4 md:space-y-6" method="post">
                    <div class="flex flex-col items-end">
                        ...
                        <input type="text" name="name" id="name"
                               class="text-right bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5   "
                               required="">
                    </div>
